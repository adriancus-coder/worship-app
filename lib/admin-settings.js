...
function createAdminSettings(db) {
  ...
  return { get, set, timezone, chordNotationDefault, themeDefault, service, clock, setClock, timeFormat };
}

module.exports = { DEFAULTS, NOTATIONS, THEME_DEFAULTS, TIME_FORMATS, isValidTimezone, createAdminSettings };
