...
//   { kind: 'black' }                  black screen (also: video items until stage 5b)
...
// Sources the leader can pick in this stage (video and translation come later).
...
function contentFrame(item, step, song) {
  ...
  switch (item.type) {
    ...
    case 'video':
      return { kind: 'black' }; // video playback: stage 5b
    default:
...
module.exports = { SOURCES, LEADER_SOURCES, projectorFrame, lyricLines };
